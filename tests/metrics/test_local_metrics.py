...
class TestLocalMetricsCalculator(unittest.TestCase):
    ...
    def create_test_repo(self) -> str:
        ...
        # Create basic files
        (Path(self.temp_repo_path) / "test.py").write_text("print('Hello!')")
        (Path(self.temp_repo_path) / "README.md").write_text("# Test\n## Usage\nExample code")
        (Path(self.temp_repo_path) / "requirements.txt").write_text("requests")
        
        # Create examples and tests
        (Path(self.temp_repo_path) / "examples").mkdir()
        (Path(self.temp_repo_path) / "tests").mkdir()
    ...
    def test_calculate_code_quality(self):
        ...
        score, latency = self.calculator.calculate_code_quality(repo_path)
    ...
    def test_calculate_ramp_up_time(self):
        ...
        score, latency = self.calculator.calculate_ramp_up_time(repo_path)
    ...
    def test_calculate_size_score(self):
        ...
        scores, latency = self.calculator.calculate_size_score(repo_path)
    ...
    def test_analyze_repository_success(self):
        ...
        for metric in ['bus_factor_latency', 'code_quality_latency', 'ramp_up_time_latency', 'size_score_latency']:
    ...
    def test_calculate_bus_factor_error_handling(self):
        ...
        score, latency = self.calculator.calculate_bus_factor("/nonexistent/path")
    ...
    def test_calculate_code_quality_error_handling(self):
        ...
        # Test with non-existent path
        score, latency = self.calculator.calculate_code_quality("/nonexistent/path")
    ...
    def test_calculate_ramp_up_time_error_handling(self):
        ...
        # Test with non-existent path
        score, latency = self.calculator.calculate_ramp_up_time("/nonexistent/path")
    ...
    def test_calculate_size_score_error_handling(self):
        ...
        # Test with non-existent path
        scores, latency = self.calculator.calculate_size_score("/nonexistent/path")
